          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
				  ...
				  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-name<?php echo $language['language_id']; ?>">HTML-тег H1:</label>
                    <div class="col-sm-10">
                      <input type="text" name="product_description[<?php echo $language['language_id']; ?>][seo_h1]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['seo_h1'] : ''; ?>" placeholder="HTML-тег H1" id="input-name<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group required">
               ...
               <div class="form-group">
                <label class="col-sm-2 control-label" for="input-totalarea"><?php echo $entry_totalarea; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="totalarea" value="<?php echo $totalarea; ?>" placeholder="<?php echo $entry_totalarea; ?>" id="input-totalarea" class="form-control" />
                </div>
              </div>
               <div class="form-group">
                <label class="col-sm-2 control-label" for="input-ucharea"><?php echo $entry_ucharea; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="ucharea" value="<?php echo $ucharea; ?>" placeholder="<?php echo $entry_ucharea; ?>" id="input-ucharea" class="form-control" />
                </div>
              </div>
               <div class="form-group">
                <label class="col-sm-2 control-label" for="input-houseroom"><?php echo $entry_houseroom; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="houseroom" value="<?php echo $houseroom; ?>" placeholder="<?php echo $entry_houseroom; ?>" id="input-houseroom" class="form-control" />
                </div>
              </div>
                                           <div class="form-group">
                <label class="col-sm-2 control-label" for="input-purpose"><?php echo $entry_purpose; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="purpose" value="<?php echo $purpose; ?>" placeholder="<?php echo $entry_purpose; ?>" id="input-purpose" class="form-control" />
                </div>
              </div>
                             <div class="form-group">
                <label class="col-sm-2 control-label" for="input-ownership"><?php echo $entry_ownership; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="ownership" value="<?php echo $ownership; ?>" placeholder="<?php echo $entry_ownership; ?>" id="input-ownership" class="form-control" />
                </div>
              </div>
                             <div class="form-group">
                <label class="col-sm-2 control-label" for="input-Light"><?php echo $entry_Light; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="Light" value="<?php echo $Light; ?>" placeholder="<?php echo $entry_Light; ?>" id="input-Light" class="form-control" />
                </div>
              </div>
                             <div class="form-group">
                <label class="col-sm-2 control-label" for="input-Gas"><?php echo $entry_Gas; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="Gas" value="<?php echo $Gas; ?>" placeholder="<?php echo $entry_Gas; ?>" id="input-Gas" class="form-control" />
                </div>
              </div>
                             <div class="form-group">
                <label class="col-sm-2 control-label" for="input-Water"><?php echo $entry_Water; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="Water" value="<?php echo $Water; ?>" placeholder="<?php echo $entry_Water; ?>" id="input-Water" class="form-control" />
                </div>
              </div>
                             <div class="form-group">
                <label class="col-sm-2 control-label" for="input-sewerage"><?php echo $entry_sewerage; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="sewerage" value="<?php echo $sewerage; ?>" placeholder="<?php echo $entry_sewerage; ?>" id="input-sewerage" class="form-control" />
                </div>
              </div>
               <div class="form-group">
                <label class="col-sm-2 control-label" for="input-kitchen"><?php echo $entry_kitchen; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="kitchen" value="<?php echo $kitchen; ?>" placeholder="<?php echo $entry_kitchen; ?>" id="input-kitchen" class="form-control" />
                </div>
              </div>
               <div class="form-group">
                <label class="col-sm-2 control-label" for="input-level"><?php echo $entry_level; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="level" value="<?php echo $level; ?>" placeholder="<?php echo $entry_level; ?>" id="input-level" class="form-control" />
                </div>
              </div>
               <div class="form-group">
                <label class="col-sm-2 control-label" for="input-storeys"><?php echo $entry_storeys; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="storeys" value="<?php echo $storeys; ?>" placeholder="<?php echo $entry_storeys; ?>" id="input-storeys" class="form-control" />
                </div>
              </div>
               <div class="form-group">
                <label class="col-sm-2 control-label" for="input-furniture"><?php echo $entry_furniture; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="furniture" value="<?php echo $furniture; ?>" placeholder="<?php echo $entry_furniture; ?>" id="input-furniture" class="form-control" />
                </div>
              </div>
               <div class="form-group">
                <label class="col-sm-2 control-label" for="input-numrooms"><?php echo $entry_numrooms; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="numrooms" value="<?php echo $numrooms; ?>" placeholder="<?php echo $entry_numrooms; ?>" id="input-numrooms" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-colnums"><?php echo $entry_colnums; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="colnums" value="<?php echo $colnums; ?>" placeholder="<?php echo $entry_colnums; ?>" id="input-colnums" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-colsanuz"><?php echo $entry_colsanuz; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="colsanuz" value="<?php echo $colsanuz; ?>" placeholder="<?php echo $entry_colsanuz; ?>" id="input-colsanuz" class="form-control" />
                </div>
              </div>
               <div class="form-group">
                <label class="col-sm-2 control-label" for="input-remont"><?php echo $entry_remont; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="remont" value="<?php echo $remont; ?>" placeholder="<?php echo $entry_remont; ?>" id="input-remont" class="form-control" />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $entry_ymore; ?></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($ymore) { ?>
                    <input type="radio" name="ymore" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="ymore" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$ymore) { ?>
                    <input type="radio" name="ymore" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="ymore" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $entry_vidmore; ?></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($vidmore) { ?>
                    <input type="radio" name="vidmore" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="vidmore" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$vidmore) { ?>
                    <input type="radio" name="vidmore" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="vidmore" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $entry_vidgori; ?></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($vidgori) { ?>
                    <input type="radio" name="vidgori" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="vidgori" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$vidgori) { ?>
                    <input type="radio" name="vidgori" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="vidgori" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $entry_komunikacion; ?></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($komunikacion) { ?>
                    <input type="radio" name="komunikacion" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="komunikacion" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$komunikacion) { ?>
                    <input type="radio" name="komunikacion" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="komunikacion" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-upc">Бейдж:</label>
                <div class="col-sm-10">
                  <!--<input type="text" name="upc" value="<?php //echo $upc; ?>" placeholder="<?php //echo $entry_upc; ?>" id="input-upc" class="form-control" />-->
									<select name="upc" class="form-control">
										<?php foreach ($badge_array as $key => $value){ ?>
										<?php if ($key == $badge_load){ ?>
