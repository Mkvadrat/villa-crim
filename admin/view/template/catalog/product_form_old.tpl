        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-pricerus"><?php echo $entry_pricerus; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="pricerus" value="<?php echo $pricerus; ?>" placeholder="<?php echo $entry_pricerus; ?>" id="input-pricerus" class="form-control" />
                </div>
              </div>
<div class="form-group">
