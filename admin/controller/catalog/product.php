...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
		...
		$data['sort_FIO'] = $this->url->link('catalog/product', 'token=' . $this->session->data['token'] . '&sort=p.FIO' . $url, 'SSL');
	...
	protected function getForm() {
		...
		$data['entry_name'] = $this->language->get('entry_name');
		$data['entry_totalarea'] = $this->language->get('entry_totalarea');
		$data['entry_houseroom'] = $this->language->get('entry_houseroom');
		$data['entry_kitchen'] = $this->language->get('entry_kitchen');
		$data['entry_level'] = $this->language->get('entry_level');
		$data['entry_storeys'] = $this->language->get('entry_storeys');
		$data['entry_furniture'] = $this->language->get('entry_furniture');
		$data['entry_numrooms'] = $this->language->get('entry_numrooms');
		$data['entry_remont'] = $this->language->get('entry_remont');
		$data['entry_pricerus'] = $this->language->get('entry_pricerus');
		$data['entry_phone'] = $this->language->get('entry_phone');
		$data['entry_FIO'] = $this->language->get('entry_FIO');
		$data['entry_purpose'] = $this->language->get('entry_purpose');
		$data['entry_ownership'] = $this->language->get('entry_ownership');
		$data['entry_Light'] = $this->language->get('entry_Light');
		$data['entry_Gas'] = $this->language->get('entry_Gas');
		$data['entry_Water'] = $this->language->get('entry_Water');
		$data['entry_sewerage'] = $this->language->get('entry_sewerage');
		$data['entry_colnums'] = $this->language->get('entry_colnums');
		$data['entry_ucharea'] = $this->language->get('entry_ucharea');
		$data['entry_colsanuz'] = $this->language->get('entry_colsanuz');
...
if (isset($this->request->get['filter_FIO'])) {
		...
		if (isset($this->request->post['totalarea'])) {
			$data['totalarea'] = $this->request->post['totalarea'];
		} elseif (!empty($product_info)) {
			$data['totalarea'] = $product_info['totalarea'];
		} else {
			$data['totalarea'] = '';
		}
				if (isset($this->request->post['houseroom'])) {
			$data['houseroom'] = $this->request->post['houseroom'];
		} elseif (!empty($product_info)) {
			$data['houseroom'] = $product_info['houseroom'];
		} else {
			$data['houseroom'] = '';
		}
				if (isset($this->request->post['kitchen'])) {
			$data['kitchen'] = $this->request->post['kitchen'];
		} elseif (!empty($product_info)) {
			$data['kitchen'] = $product_info['kitchen'];
		} else {
			$data['kitchen'] = '';
		}
			...
			$data['level'] = $product_info['level'];
		} else {
			$data['level'] = '';
		}
				if (isset($this->request->post['storeys'])) {
			$data['storeys'] = $this->request->post['storeys'];
		} elseif (!empty($product_info)) {
			$data['storeys'] = $product_info['storeys'];
		} else {
			$data['storeys'] = '';
		}
				if (isset($this->request->post['furniture'])) {
			$data['furniture'] = $this->request->post['furniture'];
		} elseif (!empty($product_info)) {
			$data['furniture'] = $product_info['furniture'];
		} else {
			$data['furniture'] = '';
		}
				if (isset($this->request->post['remont'])) {
			$data['remont'] = $this->request->post['remont'];
		} elseif (!empty($product_info)) {
			$data['remont'] = $product_info['remont'];
		} else {
			$data['remont'] = '';
		}
		/*if (isset($this->request->post['pricerus'])) {
			$data['pricerus'] = $this->request->post['pricerus'];
		} elseif (!empty($product_info)) {
			$data['pricerus'] = $product_info['pricerus'];
		} else {
			$data['pricerus'] = '';
		}*/
		...
		if (isset($this->request->post['FIO'])) {
			...
			$data['purpose'] = $product_info['purpose'];
		} else {
			$data['purpose'] = '';
		}
				if (isset($this->request->post['ownership'])) {
			$data['ownership'] = $this->request->post['ownership'];
		} elseif (!empty($product_info)) {
			$data['ownership'] = $product_info['ownership'];
		} else {
			$data['ownership'] = '';
		}
				if (isset($this->request->post['Light'])) {
			$data['Light'] = $this->request->post['Light'];
		} elseif (!empty($product_info)) {
			$data['Light'] = $product_info['Light'];
		} else {
			$data['Light'] = '';
		}
				if (isset($this->request->post['Gas'])) {
			$data['Gas'] = $this->request->post['Gas'];
		} elseif (!empty($product_info)) {
			$data['Gas'] = $product_info['Gas'];
		} else {
			$data['Gas'] = '';
		}
				if (isset($this->request->post['Water'])) {
			$data['Water'] = $this->request->post['Water'];
		} elseif (!empty($product_info)) {
			$data['Water'] = $product_info['Water'];
		} else {
			$data['Water'] = '';
		}
				if (isset($this->request->post['sewerage'])) {
			$data['sewerage'] = $this->request->post['sewerage'];
		} elseif (!empty($product_info)) {
			$data['sewerage'] = $product_info['sewerage'];
		} else {
			$data['sewerage'] = '';
		}
		if (isset($this->request->post['colnums'])) {
			$data['colnums'] = $this->request->post['colnums'];
		} elseif (!empty($product_info)) {
			$data['colnums'] = $product_info['colnums'];
		} else {
			$data['colnums'] = '';
		}
		if (isset($this->request->post['ucharea'])) {
			$data['ucharea'] = $this->request->post['ucharea'];
		} elseif (!empty($product_info)) {
			$data['ucharea'] = $product_info['ucharea'];
		} else {
			$data['ucharea'] = '';
		}
		if (isset($this->request->post['colsanuz'])) {
			$data['colsanuz'] = $this->request->post['colsanuz'];
		} elseif (!empty($product_info)) {
			$data['colsanuz'] = $product_info['colsanuz'];
		} else {
			$data['colsanuz'] = '';
		}
				if (isset($this->request->post['numrooms'])) {
			$data['numrooms'] = $this->request->post['numrooms'];
		} elseif (!empty($product_info)) {
			$data['numrooms'] = $product_info['numrooms'];
		} else {
			$data['numrooms'] = '';
		}
		...
		if (isset($this->request->post['ymore'])) {
			...
			$data['ymore'] = $product_info['ymore'];
		} else {
			$data['ymore'] = 1;
		}
		if (isset($this->request->post['vidmore'])) {
			$data['vidmore'] = $this->request->post['vidmore'];
		} elseif (!empty($product_info)) {
			$data['vidmore'] = $product_info['vidmore'];
		} else {
			$data['vidmore'] = 1;
		}
		if (isset($this->request->post['vidgori'])) {
			$data['vidgori'] = $this->request->post['vidgori'];
		} elseif (!empty($product_info)) {
			$data['vidgori'] = $product_info['vidgori'];
		} else {
			$data['vidgori'] = 1;
		}
		if (isset($this->request->post['komunikacion'])) {
			$data['komunikacion'] = $this->request->post['komunikacion'];
		} elseif (!empty($product_info)) {
			$data['komunikacion'] = $product_info['komunikacion'];
		} else {
			$data['komunikacion'] = 1;
		}
	...
	public function autocomplete() {
		...
		if (isset($this->request->get['filter_name']) || isset($this->request->get['filter_model'])|| isset($this->request->get['filter_FIO'])) {
			$this->load->model('catalog/product');
			$this->load->model('catalog/option');
