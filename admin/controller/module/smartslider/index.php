...
class ControllerModuleSmartsliderIndex extends Controller {
	...
	public function getExample() {		//index - button: get_example_slider
		...
		*/
		...
		$this->response->redirect($this->url->link('module/smartslider/index', 'token=' . $this->session->data['token'], 'SSL'));
	}
	...
	// DATA	
		$data['smartSlider'] 	= $smartSlider;
		$data['positions'] 		= $smartSlider['smartslider/index_module'];
		$data['sliders'] 		= $smartSlider['sliders'];
	// DATA		
		$data['token'] = $this->session->data['token'];
		
		$this->load->model('smartslider/slider');
		$products = $this->model_smartslider_slider->getExampleProduct();
		$data['is_example'] = count($products) ?  true : false;
		
		
	// URL
		$data['action'] 	= $this->url->link('module/smartslider/index', 'token=' . $this->session->data['token'], 'SSL');
		$data['cancel'] 	= $this->url->link('extension/module', 'token=' . $this->session->data['token'], 'SSL');
		$data['save_url'] 	= $this->url->link('module/smartslider/index/savegeneral', 'token=' . $this->session->data['token'], 'SSL');
		
		$data['getexample_url']= $this->url->link('module/smartslider/index/getexample', 'token=' . $this->session->data['token'], 'SSL');
		$data['delexampleproduct_url']= $this->url->link('module/smartslider/index/delexampleproduct', 'token=' . $this->session->data['token'], 'SSL');
		
		$data['newslider_url']= $this->url->link('module/smartslider/index/editslider', 'token=' . $this->session->data['token'], 'SSL');
		$data['editslider_url']= $this->url->link('module/smartslider/index/editslider', 'token=' . $this->session->data['token'], 'SSL');
		$data['still_editslider_url']= $this->url->link('module/smartslider/index/editslider', 'token=' . $this->session->data['token'] . '&skip_error=1', 'SSL');
		$data['duplicateslider_url']= $this->url->link('module/smartslider/index/duplicateslider', 'token=' . $this->session->data['token'], 'SSL');
		$data['removeslider_url']= $this->url->link('module/smartslider/index/removeslider', 'token=' . $this->session->data['token'], 'SSL');
		
		$data['import_url']= $this->url->link('module/smartslider/index/importall', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('module/smartslider/index.tpl', $data));
	...
	public function editslider(){		//edit
		...
		// new slider
			...
			$data['productsForSlider'] = $productsForSlider;
	...
	// URL
		...
		$data['action'] 	= $this->url->link('module/smartslider/index/editslider&id='.$id, 'token=' . $this->session->data['token'], 'SSL');
		
		$data['cancel'] 	= $this->url->link('extension/module', 'token=' . $this->session->data['token'], 'SSL');
		
		$data['save_url'] 	= $this->url->link('module/smartslider/index/saveslider&id='.$id, 'token=' . $this->session->data['token'], 'SSL');	
		
		$data['product_url'] = $this->url->link('module/smartslider/index/getproductlist', 'token=' . $this->session->data['token'], 'SSL');
		
		$data['backToList_url'] = $this->url->link('module/smartslider/index', 'token=' . $this->session->data['token'], 'SSL');
		
	//DATA	
		$data['labels']			= $this->getLabelData();
		//var_dump($this->getLabelData());
		$data['mainImagePath']		= HTTP_CATALOG.'image/';
		$data['sliderImagePath']	= HTTP_CATALOG.'image/';
		$data['layerSkinDir'] 		= DIR_CATALOG.'view/theme/default/stylesheet/smartslider/smartskins';
		$data['token'] 				= $this->session->data['token'];


		$this->response->setOutput($this->load->view('module/smartslider/edit.tpl', $data));
$data['header'] = $this->load->controller('common/header');
$data['column_left'] = $this->load->controller('common/column_left');
$data['footer'] = $this->load->controller('common/footer');
	...
	public function getproductlist() {		//edit
		...
		$data['sort_name'] = $this->url->link('module/smartslider/index/getproductlist', 'token=' . $this->session->data['token'] . '&sort=pd.name' . $url, 'SSL');
		$data['sort_model'] = $this->url->link('module/smartslider/index/getproductlist', 'token=' . $this->session->data['token'] . '&sort=p.model' . $url, 'SSL');
		$data['sort_price'] = $this->url->link('module/smartslider/index/getproductlist', 'token=' . $this->session->data['token'] . '&sort=p.price' . $url, 'SSL');
		$data['sort_order'] = $this->url->link('module/smartslider/index/getproductlist', 'token=' . $this->session->data['token'] . '&sort=p.sort_order' . $url, 'SSL');
		...
		$this->response->setOutput($this->load->view('module/smartslider/product_list.tpl', $data));
$data['header'] = $this->load->controller('common/header');
$data['column_left'] = $this->load->controller('common/column_left');
$data['footer'] = $this->load->controller('common/footer');
