	...
	public function index() {
		...
		if (isset($this->request->get['search']) || isset($this->request->get['tag'])) {
			...
			$data['sorts'][] = array(
				...
				'href'  => $this->url->link('product/search', 'sort=p.houseroom&order=ASC' . $url)
			);

			$data['sorts'][] = array(
				'text'  => $this->language->get('text_houseroom_desc'),
				'value' => 'p.houseroom-DESC',
				'href'  => $this->url->link('product/search', 'sort=p.houseroom&order=DESC' . $url)
			);$data['sorts'][] = array(
				'text'  => $this->language->get('text_totalarea_asc'),
				'value' => 'p.totalarea-ASC',
				'href'  => $this->url->link('product/search', 'sort=p.totalarea&order=ASC' . $url)
			);

			$data['sorts'][] = array(
				'text'  => $this->language->get('text_totalarea_desc'),
				'value' => 'p.totalarea-DESC',
				'href'  => $this->url->link('product/search', 'sort=p.totalarea&order=DESC' . $url)
			);
			if ($this->config->get('config_review_status')) {
				$data['sorts'][] = array(
