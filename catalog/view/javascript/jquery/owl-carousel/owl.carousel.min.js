"function" != typeof Object.create && (Object.create = function(t) {
    ...
    function(t, e, o) {
        var i = {
            ...
            $( ".owl-wrapper-outer" ).before( "<div class='podlojka'><img src='/image/catalog/podlojkaslid.png'></div>" );
            },
            baseClass: function() {
                var t = this,
            ...
            calculateWidth: function() {
                var t = this;
                t.itemWidth = Math.round(t.$elem.height() / t.options.items)
            },
            max: function() {
                var t = this,
